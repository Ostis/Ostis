...
First, download the OSTIS App on the Google Play Store

Install it on your Smartphone

Then, the app will ask you to connect the smartphone to the drone by Wifi.
Once the connection is done, the app will show you all the commands pre-recorded that you can use.

Finally you can ask the AR.Drone to do every loaded command.
